 ...
 * for uploading the tarball and other assignment related details.
 ...
 * to build or compile the uploaded assignment. It logs and displays the response
 * from server(i.e output of compilation) and also logs any error encountered.
 */
 ...
 * to execute or run the uploaded assignment. It logs and displays the response
 * from server(i.e output of execution) and also logs any error encountered.
 */
 ...
 * Allowed file types are 'application/zip', 'application/x-tar','application/gzip'.
 * Displays error in 'formError' HTML element if a file is not selected within allowed types.
...
/**
 * Validates file selection. Displays error message in 'formError'
 * HTML element if a file is not selected.
 */
...
/**
 * Validates command to compile. Displays error message in 'formError'
 * HTML element if command to compile is empty.
 */
...
/**
 * Validates command to run. Displays error message in 'formError'
 * HTML element if command to run is empty.
 */
...
/**
 * Appends a new div element with two text boxes to the 'cmdArgs' HTML element
 * on click of 'Add' button. The text boxes are for adding command line arguments in key-value form.
 */
function appendRow()
{
    cmdArgsEnabled = true;
